...
#define BLYNKBOARD_FIRMWARE_VERSION "1.0.2"
...
#define RGB_STATUS_CONNECTING_BLYNK   0x00270C // Blynk Green - connecting to Blynk cloud
#define RGB_STATUS_CONNECTED_BLYNK    0x00270C // Blynk Green - Connected to Blynk cloud
